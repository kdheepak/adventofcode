...
mod tests {
  ...
  fn test_day04_part1() {
    ...
    "};
    let prob = Day04 {};
    assert_eq!(prob.part1(input), Some("4512".to_string()));
    assert_eq!(prob.part1(&crate::get_input(4)), Some("60368".to_string()));
  }
  ...
  fn test_day04_part2() {
    ...
    "};
    let prob = Day04 {};
    assert_eq!(prob.part2(input), Some("1924".to_string()));
    assert_eq!(prob.part2(&crate::get_input(4)), Some("17435".to_string()));
  }
}
